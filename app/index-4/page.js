            ...
            <div className="col-lg-6">
              <div className="hero-content">
                ...
                <p className="wow fadeInUp" data-wow-delay=".5s">
                  Transform your workspace with Indalio's premium monitor arms.
                  Engineered in Ludhiana, <br />
              ...
              <div className="col-lg-6">
                <div className="about-content">
                  ...
                  <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                    With over 25 years of manufacturing excellence, Indalio delivers innovative monitor mounting solutions 
                    designed for modern workspaces across corporate offices, healthcare, and trading environments.
                  </p>
                  <ul
